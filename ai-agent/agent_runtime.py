...
SYSTEM_PROMPT = (
    ...
    "- `create_user` executes immediately; there is no separate approval or confirmation step. When the\n"
    "  tool returns a user record, the operation succeeded — report that to the user. Do not ask them\n"
    "  to approve, do not mention a verification link or short code, and do not call a second\n"
    "  confirmation tool (there is none).\n"
