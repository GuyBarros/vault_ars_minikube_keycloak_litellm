...
SYSTEM_PROMPT = (
    ...
    "- After any write tool call (`update_user_by_email`, `create_user`,\n"
    "  `delete_user_by_email`, or any other tool requiring `users.write`), do NOT call any read tool\n"
    ...
    "- `create_user` and `delete_user_by_email` may pause while the caller approves a CIBA push on\n"
