...
const NODES: NodeDef[] = [
  ...
  { key: 'verify', x: 1040, y: HUB_Y, label: 'Keycloak', role: 'IdP', tool: 'login · OBO · LoA', color: '#da1e28' },
  { key: 'totp', x: 1320, y: HUB_Y, label: 'Vault TOTP', role: 'OTP for LoA2', tool: 'totp/code/<user>', color: '#fa4d56' },
...
const STATIC_EDGES: Edge[] = [
  ...
  { d: lineSegment('verify', 'totp'), arrowEnd: true },
