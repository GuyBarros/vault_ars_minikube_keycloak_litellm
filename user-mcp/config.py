...
class Settings(BaseSettings):
    ...
    # JWT validation
    keycloak_base_url: str = Field(default="", alias="USER_MCP_KEYCLOAK_BASE_URL")
    keycloak_jwks_url: str = Field(default="", alias="USER_MCP_KEYCLOAK_JWKS_URL")
    ...
    vault_jwt_read_role: str = Field(default="user-mcp-oidc-read", alias="USER_MCP_VAULT_JWT_READ_ROLE")
    vault_jwt_write_role: str = Field(default="user-mcp-oidc-write", alias="USER_MCP_VAULT_JWT_WRITE_ROLE")
    ...
    def effective_issuer(self) -> str:
        return self.issuer or self.keycloak_base_url
    ...
    def effective_jwks_url(self) -> str:
        ...
        if not self.keycloak_base_url:
            return ""
        # Keycloak's standard per-realm JWKS endpoint.
        return self.keycloak_base_url.rstrip("/") + "/protocol/openid-connect/certs"
...
def load_settings() -> Settings:
    ...
    log_event(
        ...
        keycloak_issuer=settings.effective_issuer or None,
