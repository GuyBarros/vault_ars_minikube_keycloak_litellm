...
from keycloak.obo_broker import OBOBroker, claim_from_token
...
async def exchange_obo_token(
    ...
    """Exchange subject_token + actor_token for a Keycloak OBO access token."""
    ...
    try:
        ...
        return JSONResponse(
            status_code=503, content={"detail": "Keycloak is unavailable"}
        )
